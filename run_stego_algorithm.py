...
NUM_CHANNELS = 3
COVER_IMAGE_FILEPATH  = "D:\\securityenhancement\\static\\images\\img3.jpg" # Choose your cover image (PNG)
STEGO_IMAGE_FILEPATH  = "a.png"
SECRET_MESSAGE_STRING = "hello welcome to python programming , welcome to java programming , welcome to cpp , welcome to c, welcome to db"
